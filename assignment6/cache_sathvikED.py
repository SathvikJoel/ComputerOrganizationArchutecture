...
class replacer:
    ...
    def __call__(self, addr, access_type, tag, set_num, cache_set ):
            if( self.policy == 0):
                ...
                self.random_evict( access_type, tag,cache_set)
            ...
            if( self.policy == 2):
                ...
                # capacity miss
                if( hit_status == -1): capacity_conflict_update(self)
    ...
    def tag_check(self, tag, cache_set):
        ...
        if( self.policy == 0):
            ...
            if( curr!= None and curr.tag == tag ):  return True
            return False
    ...
    def LRU_evict(self, tag, cache_set):            
        curr = cache_set.head
        prev = None
        pprev = None
        while( curr != None and curr.valid_bit != False):
